...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    //teste com ajuste de preço
    test.each([
        ['com ajuste de preço para dinheiro', 'dinheiro', 'R$ 2,85', ['cafe,1']],
        ['com ajuste de preço para crédito', 'credito', 'R$ 3,09', ['cafe,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));

    //teste com quantidade 0 ou negativa
    test.each([
        ['com quantidade zero', 'dinheiro', 'Quantidade inválida!', ['cafe,0']],
